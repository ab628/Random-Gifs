...
const Tag = () => {
  ...
  return (
    <div className="w-1/2  bg-blue-400 rounded-lg border border-black flex flex-col items-center gap-y-5 mt-[15px]">
        ...
        {loading ? (<Spinner/>) : (<img src={gif} width="450" alt="gifImage"/>)}

        <input className="w-10/12  bg-white opacity-90 text-lg py-2 rounded-lg mb-[3px] text-center " placeholder=" Search GIF Here..." 
